...
var NON_INTERACTIVE_CLIENT_ID = '7fRRqwtXL6HYGYgc64MaivYVfDLUoqpZ';
var NON_INTERACTIVE_CLIENT_SECRET = 'rtwcspWU1yZFHCRmh1rM9JX0NyL-MJu3v75RPREdMzgoBcXCR9Hy5cG5kD9z3l6P';
...
var authData = {
    ...
    audience: 'https://MovieAnalystAPI.com'
};
...
function getAccessToken(req, res, next) {
    request
        .post('https://viraj2252.au.auth0.com/oauth/token')
        .send(authData)
